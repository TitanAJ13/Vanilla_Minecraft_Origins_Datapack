...
scoreboard objectives add originsBeeFloat dummy
scoreboard objectives add originsBeeFloatTimer dummy
...
scoreboard objectives add originsBeePoisonPriority dummy
...
scoreboard objectives add originsThrewPearl minecraft.used:minecraft.ender_pearl
