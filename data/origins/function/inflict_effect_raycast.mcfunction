...
$execute as @s at @s run effect give @e[scores={originsInflictEffectPriority=13},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=12},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=12..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=11},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=11..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=10},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=10..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=9},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=9..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=8},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=8..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=7},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=7..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=6},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=6..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=5},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=5..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=4},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=4..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=3},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=3..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=2},distance=..5,limit=1] $(Id) 2 1 false
$execute as @s at @s unless entity @e[scores={originsInflictEffectPriority=2..13},distance=..5] run effect give @e[scores={originsInflictEffectPriority=1},distance=..5,limit=1] $(Id) 2 1 false
