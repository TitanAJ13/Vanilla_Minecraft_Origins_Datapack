...
scoreboard players remove @a[scores={originsCooldownTimer=18..}] originsCooldownTimer 1
...
scoreboard players set @a[scores={originsCooldownTimer=17}] originsCooldownTimer 0
